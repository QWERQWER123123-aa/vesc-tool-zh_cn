...
**VESC®** 是 Benjamin Vedder 的注册商标。请阅读完整的[商标政策](https://vesc-project.com/trademark_policies) 。

### 二进制发布限制

- VESC Tool 的"官方"二进制发布 **仅通过 VESC Project** 进行，这确保用户能验证使用 VESC 注册商标的发布确实来自 VESC Project
- **不允许** 在其他渠道托管二进制发布并同时使用 VESC 商标

### Fork 与贡献

- ✅ 通过 GitHub Fork 贡献代码是 OK 的（因为 Fork 仓库会明确标注来源）
- ❌ 不鼓励在 GitHub Fork 仓库中提供二进制发布
- ✅ 无品牌的 Fork（移除所有 VESC 商标痕迹）在法律上不违反商标政策，但从道义上仍不鼓励

### 为什么不鼓励独立 Fork？

1. **混淆用户**：多个版本让用户难以辨别官方版本
2. **分流社区**：将用户从 VESC Project 引流走，减少了了解项目和捐赠的机会
3. **安全风险**：未经主要开发者审查的修改可能存在安全隐患

> 💡 **建议**：如果你发现缺失的功能并投入了精力去实现，请将其贡献回主仓库！这样所有用户都能受益，代码也会经过作者审查以保证兼容性和安全性。
...
VESC Tool 是完全免费的软件，但其开发与维护需要巨大的精力投入。VESC 生态系统的绝大部分捐赠来自 VESC Tool 的下载用户。

如果您觉得 VESC Tool 对您有帮助，欢迎通过官网进行捐赠：

👉 **[http://vesc-project.com/](http://vesc-project.com/)**

您的支持将帮助 VESC 生态持续健康发展！❤️
...
> **作者**：Benjamin Vedder（benjamin@vedder.se）
>
> **版权**：© 2016 - 2024 Benjamin Vedder，基于 GPLv3 协议发布
>
